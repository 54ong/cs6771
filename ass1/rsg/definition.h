...
/**
 * Encapulates the data necessary to capture the notion of a CFG Definition.
 * A Definition is just a nonterminal paired with all of its possible expansions.
 */
...
public:
	 ...
	 * -------------------------------
	 * Constructs an instance of the Defintion class with the nonterminal string("")
	 * and an empty collection of Productions.
	 * This is supplied for the purposes of embedding the Definition in a vector or
	 * some other STL container that requires its elements to have a default constructor.
	 */
	 ...
	 * --------------------------------
	 * Constructs an instance of the Definition instance based on the contents of the
	 * specified ifstream.
	 *
